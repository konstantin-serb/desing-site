...
function checkParentsDecor($params, $id, $commentator_id)
{
...
<?php if (!empty($innerTree)): ?>
    ...
    <div class="comments">
        ...
        function viewDecor($innerTree, $commentsModel, $updateAnswerModel, $params)
        { ?>
            <ul class="comment-tree client">
                <?php foreach ($innerTree as $key => $value): ?>
                        ...
                        <div class="one-comment <?php if ($value['commentator_id'] == Yii::$app->user->identity->getId()) {
                            ...
                            <div class="top-comment">
                                ...
                                <div class="closeBlock">
                                    <?php if (checkParentsDecor($params, $value['id'], $value['commentator_id'])): ?>
                    ...
                    <?php if (!empty($value['children'])): ?>
                        <li>
                            <?php viewDecor($value['children'], $commentsModel, $updateAnswerModel, $params); ?>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
            </ul>
        ...
        viewDecor($innerTree, $commentsModel, $updateAnswerModel, $params);
        ?>
