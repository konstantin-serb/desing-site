...
$innerTree = $furnitureTree;

//dumper($params['allComments']);die;

function checkParentsFurniture($params, $id, $commentator_id)
{
...
<?php if (!empty($innerTree)): ?>
    ...
    <div class="comments">
        ...
        function viewFurniture($innerTree, $commentsModel, $updateAnswerModel, $params)
        { ?>
            <ul class="comment-tree client">
                <?php foreach ($innerTree as $key => $value): ?>
                        ...
                        <div class="one-comment <?php if ($value['commentator_id'] == Yii::$app->user->identity->getId()) {
                            ...
                            <div class="top-comment">
                                ...
                                <div class="closeBlock">
                                    <?php if (checkParentsFurniture($params, $value['id'], $value['commentator_id'])): ?>
                    ...
                    <?php if (!empty($value['children'])): ?>
                        <li>
                            <?php viewFurniture($value['children'], $commentsModel, $updateAnswerModel, $params); ?>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
            </ul>
        ...
        viewFurniture($innerTree, $commentsModel, $updateAnswerModel, $params);
        ?>
