...
class AddFromContractContractForm extends Model
{
    public $projectId;
    public $contractId;
    public $customer;
    ...
    {
        return [
            [['projectId', 'contractId'], 'integer'],
            [['projectId', 'contractId', 'address', 'customer', 'dateContract', 'dateStart',
    ...
    public function save()
    {
        if($this->validate()) {
            ...
            $template = Contracts::findOne($this->contractId);
            ...
            $contract->executor_info = $template->executor_info;
            ...
            $contract->executor_organization = $template->executor_organization;
            $contract->executor_director = $template->executor_director;
            $contract->contract_nom = $project->project_id;
            $contract->contract_city = $template->contract_city;
