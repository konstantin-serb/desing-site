...
class EditCharacteristicsForm extends Model
{
    public $question;
    public $description;
    public $projectId;
    ...
    {
        if ($this->validate()) {
            $newQuestion = new Characteristic();
            ...
            $newQuestion->status = Characteristic::EDITED;

            $allQuestions = Characteristic::find()
