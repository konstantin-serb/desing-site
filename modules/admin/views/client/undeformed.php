    ...
    <section class="top">
        <div class="myContainer">
            <div class="adminCreate">
                <h2>Новый клиент добавлен!</h2>
                <h5>1й этап регистрации закончен</h5>
                <h5 class="subtitle">Добавлен новый клиент:</h5>
            </div>
            <div class="client-name">
                <div class="input-group">
                    <p><a href="<?=Url::to(['/admin/client/view',
    ...
    <section class="client-info">
        <div class="myContainer">
            ...
            <div class="info-block">
                <p class="myLabel">Ссылка для регистрации клиента:</p>
                <div class="input-group">
                    <p>http://interior/site/register</p>
                </div>
            ...
            <div class="bottom-block">
                <p>
                    * - Код регистрации одноразовый. При регистрации заказчика, код самоуничтожается, что предотвращает
                    возможность
                ...
                <div class="gold-button">
                    <a class="a-link login-button" href="<?=Url::to(['/admin/client/view',
                    'id'=>$user->id])?>">OK</a>
                </div>
            </div>
        </div>
