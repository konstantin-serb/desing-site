...
<div class="mainContent userPage">
    <section class="top">
        <div class="myContainer">
            ...
            <h5>Добрый день <?=$user->user_name ?> <?= $user->last_name ?>!
                <wbr>
    ...
    <section class="personalData">
        <h2><a href="<?=Url::to(['/customer/personal-data'])?>" class="a-link">Личные данные</a></h2>
        <div class="myContainer">
            <div class="button">
                <a href="<?=Url::to(['/customer/personal-data'])?>" class="a-link">Изменить личные данные</a>
            </div>
            <hr>
        </div>
    </section>
