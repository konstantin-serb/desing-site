...
<div class="mainContent">
    <div class="myContainer">
        <div class="top">
            <h2>Удаление шаблона для анкеты</h2>
        </div>
        <br><br>
        ...
        <div class="delete-block">
            ...
            <h3>Вы действительно хотите удалить тип анкеты:</h3>
            ...
            <h5><span class="del-red">При удалении типа анкеты, будут удалены и все вопросы, которые относятся к этому типу</span></h5>
            <?php ActiveForm::end();?>
        </div>
