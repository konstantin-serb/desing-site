...
$innerTree = $livingTree;

//dumper($params['allComments']);die;

function checkParentsLiving($params, $id, $commentator_id)
{
...
<?php if (!empty($innerTree)): ?>
    ...
    <div class="comments">
        ...
        function viewLiving($innerTree, $commentsModel, $updateAnswerModel, $params)
        { ?>
            <ul class="comment-tree client">
                <?php foreach ($innerTree as $key => $value): ?>
                        ...
                        <div class="one-comment <?php if ($value['commentator_id'] == Yii::$app->user->identity->getId()) {
                            ...
                            <div class="top-comment">
                                ...
                                <div class="closeBlock">
                                    <?php if (checkParentsLiving($params, $value['id'], $value['commentator_id'])): ?>
                    ...
                    <?php if (!empty($value['children'])): ?>
                        <li>
                            <?php viewLiving($value['children'], $commentsModel, $updateAnswerModel, $params); ?>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
            </ul>
        ...
        viewLiving($innerTree, $commentsModel, $updateAnswerModel, $params);
        ?>
