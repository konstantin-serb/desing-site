 ...
 * @var $modelPhoto \app\models\forms\project\UploadProjectPictureForm
 *
 */
...
$this->registerJsFile('/files/js/addCurrencyAJAX.js', [
    'depends' => \yii\web\JqueryAsset::class,
]);
    ...
    <section class="addProject">
        <div class="myContainer">
            ...
            <div class="formStyle all-width">
                ...
                <div class="form-group">
                    <?= $form->field($modelPhoto, 'projectPhoto')->fileInput()->label('Выберете фото для проекта') ?>
                </div>
                <br>
                <hr>
                <div class="bigGroup">
                            ...
                            <div class="price-wrap">
                                ...
                                <div class="mod-group" id="price__group2">
                                    ...
                                    <div class="form-group plus-link">
                                        ...
                                        <div class="modal-footer">
                                            <button id="addCurrency" type="button" class="btn btn-primary">Добавить
                                            </button>
                                        </div>
