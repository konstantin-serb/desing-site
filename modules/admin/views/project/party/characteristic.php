...
<div class="container-questions">
    ...
    <?php foreach ($questions as $question):?>
        ...
        if($question->status == \app\models\Characteristic::NO_EDITED) {
            echo 'no-edited';
        }
        ?>">
            <?php if($question->status == \app\models\Characteristic::EDITED):?>
            <a href="<?= Url::to(['update-characteristic', 'id' => $question->id]) ?>" class="a-link">
                <?php endif;?>
